...
export function OnboardingPage() {
  ...
  return (
    <div>
      ...
      <div className="grid gap-4 pb-28 md:gap-5 md:pb-0 xl:grid-cols-[minmax(0,720px)_280px] xl:justify-center">
        <div className="mx-auto w-full max-w-[720px] space-y-4 xl:mx-0">
                ...
                return (
                  ...
                  >
                    ...
                    <div className="relative z-10 flex flex-col items-center gap-2 text-center">
                      ...
                      <span
                        className={cn(
                          'hidden text-[11px] font-medium leading-5 sm:block sm:text-xs',
          ...
          >
            ...
            <div className="mt-6 hidden items-end justify-between gap-4 md:flex">
              <Button
                type="button"
                variant="ghost"
